package com.skye.yunpicturebackend.manager.auth;


import cn.hutool.core.io.resource.ResourceUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.skye.yunpicturebackend.manager.auth.model.SpaceUserAuthConfig;
import com.skye.yunpicturebackend.manager.auth.model.SpaceUserRole;
...
/**
 * 空间用户权限管理，加载配置文件，并提供 根据角色获取权限列表的方法
 */
@Component
