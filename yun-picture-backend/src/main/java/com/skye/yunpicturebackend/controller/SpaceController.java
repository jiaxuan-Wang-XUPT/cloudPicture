...
import com.skye.yunpicturebackend.model.dto.space.SpaceEditRequest;
import com.skye.yunpicturebackend.model.dto.space.SpaceQueryRequest;
import com.skye.yunpicturebackend.model.dto.space.SpaceUpdateRequest;
...
public class SpaceController {
    ...
    /**
     * 根据 id 获取空间（封装类）(用户使用)（正常情况下仅本人需要补充权限）
     */
    @GetMapping("/get/vo")
